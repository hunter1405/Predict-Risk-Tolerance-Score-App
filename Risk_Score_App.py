...
st.title("Risk Tolerance Score Prediction App","Hello")
...
if uploaded_file is not None:
    ...
    def user_input_features():
        ...
        Ratio = st.selectbox(' ',('A. <20%','B. 20%-50%','C. >50%'))
